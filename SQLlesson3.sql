...
INSERT INTO `profiles` (staff_id, birthday) VALUES 
(1, '1961-11-08'),
(2, '1992-12-20'),
(3, '2004-06-15'),
(4, '1988-11-07'),
...
-- Вывести сотрудников, указав возраст из профиля
SELECT 	
	staff_id,
	TIMESTAMPDIFF(YEAR, birthday, NOW()) AS age 
	-- функция определяет разницу между датами в выбранных единицах (YEAR)
FROM profiles;
